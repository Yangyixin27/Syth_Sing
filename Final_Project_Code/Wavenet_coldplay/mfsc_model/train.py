...
DATA_DIRECTORY = "/Users/muyang/Desktop/EE599_Speech/2018_synth_sing_proj/Dataset/coldplay_data_npy/mfsc/"
LOGDIR_ROOT = './logdir_lr00005'
CHECKPOINT_EVERY = 500
NUM_STEPS = int(1e7)
LEARNING_RATE = 0.00005
WAVENET_PARAMS = './wavenet_params.json'
STARTED_DATESTRING = "{0:%Y-%m-%dT%H-%M-%S}".format(datetime.now())
SAMPLE_SIZE = 32   # this means how many frames
...
def main():
    ...
    with tf.name_scope('create_inputs'):
        ...
        mfsc_batch, lc_batch = reader.dequeue(args.batch_size)
    ...
    # pdb.set_trace()
    loss = net.loss(input_batch=mfsc_batch,                                # audio_batch shape: [receptive_filed + sample_size, 1]
                    lc_batch = lc_batch,
    ...
    try:
        for step in range(saved_global_step + 1, args.num_steps):
            ...
            # acous, lc, loss_val= sess.run([mfsc_batch, lc_batch, loss])
