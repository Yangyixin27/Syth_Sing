...
# python generate.py --samples 3200  --wav_out_path generated_004.npy --gc_channels=32 --gc_cardinality=2 --gc_id=1 /Users/muyang/Desktop/EE599_Speech/2018_synth_sing_proj/Wavenet/logdir/train/2018-11-20T23-05-16/model.ckpt-99999
...
def load_lc(clip_id=None, scramble=False):
    ...
    filename = "coldplay_song"


    if clip_id:
        F0 = np.load(f0_path + filename + clip_id + ".npy")
        # F0 = np.load("/Users/muyang/Desktop/EE599_Speech/2018_synth_sing_proj/Dataset/HTS-demo_NIT-SONG070-F001/data/f0_pert_004.npy")
    ...
    if scramble:
        ...
        phone = np.load("/Users/muyang/Desktop/EE599_Speech/2018_synth_sing_proj/Dataset/HTS-demo_NIT-SONG070-F001/data/phone_scramble.npy")
        concat = np.concatenate((F0, phone), axis=-1)
...
def main():
    ...
    if args.wav_seed:
        ...
        lc_array = load_lc(clip_id = "06_04_026") # clip_id:[003, 004, 007, 010, 012 ...]
