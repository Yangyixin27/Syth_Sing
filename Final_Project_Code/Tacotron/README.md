...
We train the model on datasets prepared by ourself.
## Training
  * STEP 0. Create a folder called "data", prepare your own data and create wav file and aligned csv file, put them both in "data" folder.
