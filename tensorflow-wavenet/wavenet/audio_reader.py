...
def load_acous_F0_phones(directory, sample_rate):
    ...
    for filename in randomized_files:
        ...
        acous = np.load(mfsc_path + filename)
        ...
        yield acous, F0, prev_phone, cur_phone, next_phone, phone_pos, filename, category_id
...
class AudioReader(object):
    ...
    def __init__(self, 
        ...
        self.acou_feat_dim = acou_feat_dim,
        self.F0_dim=F0_dim
        self.phone_dim = phone_dim
        self.phone_pos_dim = phone_pos_dim
        self.lc_dim = F0_dim + 3 * phone_dim + phone_pos_dim   # F0, 3 * phone_identity, phone position 
    ...
    def thread_main(self, sess):
        ...
        while not stop:
            ...
            for acous, F0, prev_phone, cur_phone, next_phone, phone_pos, filename, category_id in iterator:
                print (filename)
