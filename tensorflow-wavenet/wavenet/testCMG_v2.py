...
"""
Either this is the right version, or the one that we used before, 
...
def get_mu(location, sigma1, sigma2, sigma3, sigma4, skewness, gamma_u):
  ...
  mu2 = location + sigma2 * gamma_u * skewness   # or: location + sigma1 * gamma_u * skewness
  mu3 = location + 2 * sigma3 * gamma_u * skewness   # or: location + (sigma1 + sigma2) * gamma_u * skewness
  mu4 = location + 3 * sigma4 * gamma_u * skewness   # or: location + (sigma1 + sigma2 + sigma3) * gamma_u * skewness
